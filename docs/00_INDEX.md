...
This file is an index only. It is not the global project status.

## Sources of Truth

| Purpose | Canonical file |
|---|---|
| Master architecture and investment-system rules | `docs/MASTER_DEVELOPMENT_GUIDE.md` |
...
Phase 0 is complete according to `DevelopPlans/STATUS.md`. The task files below are retained as task instructions/reference material, not as current progress state.

| Order | Task File | Goal |
|---:|---|---|
| 0 | `phase0/TASK_000_REPOSITORY_AUDIT.md` | Inspect repository and document current state |
| 1 | `phase0/TASK_001_PROJECT_GUARDRAILS.md` | Create project guardrails |
| 2 | `phase0/TASK_002_GAP_ANALYSIS.md` | Compare repo against master guide |
