...
import yaml
from config import INDICATORS_YAML, validate_config
from storage.database import init_db, upsert_indicator, log_collect, get_previous_value, log_collector_run
...
def collect_all_indicators():
    ...
    try:
        from engine.features.relative_strength import compute_relative_strength
    ...
    try:
        ...
        from storage.database import save_features, save_signal, mark_signal_notified
...
if __name__ == "__main__":
    ...
    try:
        from ingestion.ir_scraper import get_new_filings, fetch_filing_text, count_ai_bottleneck_keywords
        from agents.gemini_client import summarize_ir
        from storage.database import save_ir_filing, save_ir_keyword_mentions
